...
# ==============================================================================
# UNUSED / FUTURE ALTERNATIVE PROMPT: MULTI-CHANNEL 24/7 AI ASSISTANT PITCH
# (Uncomment and replace OUTBOUND_PROMPT below when running 24/7 AI Agent campaigns)
# ==============================================================================
# OUTBOUND_AI_ASSISTANT_PROMPT = """You are Sarah, an outbound consultant calling US-based roofing contractors.
...
# - You built a custom 24/7 AI Lead Assistant for their business as a free gift (Social Media DMs, WhatsApp text/voice, Web Chat, Phone Voice AI).
